========================================================================
    KONSOLENANWENDUNG: export_distCoeffs-Projektübersicht
========================================================================

Diese export_distCoeffs-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre export_distCoeffs-Anwendung besteht.


export_distCoeffs.vcxproj
...
export_distCoeffs.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen export_distCoeffs.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
